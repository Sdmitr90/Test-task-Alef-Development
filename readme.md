Выполнено: Адаптивная верстка для расширений: 1280(PixelPerfect) 1024 768 375
Проверена кроссбраузерность на десктопном расширении: IE11, GoogleChrome, Mozila, Opera, Яндекс
JS: В IE11 работают валидация и прокрутка.
